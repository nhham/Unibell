...
#Preview {
    SingleTaskView(scheduleModel: AgendaScheduleViewViewModel(userUID: "asdasd"), item: .init(id: "123", title: "Walk my dog", dueDate: Date().timeIntervalSince1970, createdDate: Date().timeIntervalSince1970, color: "#000080", isDone: false))
}
